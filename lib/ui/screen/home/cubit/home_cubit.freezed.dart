...
class _$HomeStateImpl extends _HomeState {
  const _$HomeStateImpl(
      {this.loading = true,
      final List<String> emailList = const [],
  ...
  @override
  String toString() {
    return 'HomeState(loading: $loading, emailList: $emailList, contacts: $contacts, groups: $groups, index: $index)';
  }
...
abstract class _HomeState extends HomeState implements BaseState {
  const factory _HomeState(
      ...
      final int index}) = _$HomeStateImpl;
